...
def load_face_mask_models(face_model_path, mask_model_path):
...
def mask_detection():
    ...
    faceNet, maskNet = load_face_mask_models("face_detector", "mask_detector.model")
    ...
    if choice == 'Webcam':
        ...
        st.markdown("Click on 'Start' to begin webcam detection.")
        ...
        if st.button('Start'):
            ...
            while True:
                ...
                for (box, pred) in zip(locs, preds):
                    ...
                    if stop_button:
                        vs.stop()
                        st.markdown('<h3 align="center">Webcam stopped.</h3>', unsafe_allow_html=True)
                        break
